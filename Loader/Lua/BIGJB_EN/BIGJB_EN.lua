--This is only a beta test version, all the features caused by instability, have tried to avoid, due to the development did not provide api information about the menu itself, so the function is not perfect, or can not be reached.
...
ui.create_sub("Self", "self_tab")
ui.create_sub("Weapons", "weap_tab")
ui.create_sub("Vehicles", "veh_tab")
ui.create_sub("Others", "other_tab")
ui.create_sub("Global", "session_tab")
ui.create_sub("World", "world_tab")
ui.create_sub("Players", "player_tab")
------------------------------------------------------------------------------------------------------------------------------循环变量
...
stopworldlp = 0
------------------------------------------------------------------------------------------------------------------------------自我选项
ui.sub_button("Self Options", "Self functions.", empty_button, "lua_main_tab", "self_tab")

ui.create_sub("Camera", "cam_tab")
ui.sub_button("Camera", "Adjust camera settings.", empty_button, "self_tab", "cam_tab")
...
ui.toggle_button("Stop Camera Shake", "Prevent events that cause your camera to shake.", stop_cam_shake_loop, stop_cam_shake_off, "cam_tab", "stop_cam_shake_loop")
...
ui.toggle_button("Stop Idle Camera", "Stop the function that allows you to look around when idle.", stop_idle_cam_loop, empty_function, "cam_tab", "stop_cam_shake_loop")
...
ui.toggle_button("Head 520", "Generate a 520 effect above your head.", head_520_loop, head_520_off, "self_tab", "head_520")
...
------------------------------------------------------------------------------------------------------------------------------全局选项
ui.sub_button("Session Options", "Functions applied in the session.", empty_button, "lua_main_tab", "session_tab")

ui.create_sub("Session Crash", "crash_tab")
ui.sub_button("Session Crash", "Crash everyone in the session.", empty_button, "session_tab", "crash_tab")
...
ui.button("UFO Crash", "Aliens will take them away.", ufo_crash, "crash_tab", "ufo_crash")
...
ui.button("Falling Crash", "Smash them all to death.", falling_crash, "crash_tab", "falling_crash")
...
ui.toggle_button("Script Sound Crash", "Pretty good sound which cause their game crash.", sound_crash_loop, empty_function, "crash_tab", "sound_crash")

ui.create_sub("Cage", "cage_tab")
ui.sub_button("Cage", "Spwan various cages.", empty_button, "trolling_tab", "cage_tab")
...
ui.button("Colorful Cage", "Spawn a cage that dazzles you.", tube_cage, "cage_tab", "tube_cage")
...
ui.button("Security Room Cage", "Make players become security guards.", sechut_cage, "cage_tab", "sechut_cage")
...
ui.button("Elevator Cage", "Spawn an elevator that traps players.", elevator_cage, "cage_tab", "elevator_cage")
...
ui.button("Container Cage", "Spawn a container that envelops players.", storage_cage, "cage_tab", "storage_cage")
...
ui.button("Small Cage", "Spawn a small cage.", small_cage, "cage_tab", "small_cage")
...
ui.button("Clear Cages", "Remove all cages you have spawned.", delete_all_cage, "cage_tab", "delete_all_cage")

ui.create_sub("Trolling", "trolling_tab")
ui.sub_button("Trolling", "Troll the players in the session.", empty_button, "session_tab", "trolling_tab")
...
ui.toggle_button("Global Wanted", "Players in the session will be wanted.", session_wanted, empty_function, "trolling_tab", "session_wanted")
...
ui.button("Vehicle Trapping", "Vehicles will trap them.", veh_trapping, "trolling_tab", "veh_trapping")
...
ui.button("Disable Orbital Cannon", "Prevent everyone from using the orbital cannon.", stop_orbroom, "trolling_tab", "stop_orbroom")
...
ui.button("Air Raid Siren", "Sound the air raid siren in the session.", Air_Defences, "trolling_tab", "Air_Defences")

ui.create_sub("Friendly", "friendly_tab")
ui.sub_button("Friendly", "Apply friendly functions to session.", empty_button, "session_tab", "friendly_tab")
...
ui.toggle_button("Global No Wanted", "Players in the session will not be wanted.", session_no_wanted, empty_function, "friendly_tab", "session_no_wanted")
...
------------------------------------------------------------------------------------------------------------------------------世界选项
ui.sub_button("World Options", "Functions applied in the world.", empty_button, "lua_main_tab", "world_tab")
...
ui.toggle_int_slider_button("Lock Time", "0 is morning, 1 is night.", lock_time_loop, lock_time_off, 0, 1, 0, "world_tab", "lock_time")
